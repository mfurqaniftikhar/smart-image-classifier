"""
Random Forest Trainer for Medium Datasets
"""
import numpy as np
...
class RandomForestTrainer:
    """
    Random Forest model trainer for medium datasets
    """
    ...
    def train(self, X, y, class_names, test_size=0.2, n_estimators=100):
        """
        Random Forest model ko train karta hai
